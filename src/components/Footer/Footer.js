  ...
  return (
    ...
    <footer className={classes.footer}>
      <div className={classes['footer-container']}>
        ...
        <div className={classes['more-info']}>
          <div className={classes['footer-section']}>
            ...
            <p>
              ...
              men, women and kids in India, you are at the right place. Mystyle
              ...
              accessories, jewelry, personal care products and more. It is time
              to redefine style statement with our treasure-trove of trendy
              items. Our online online store brings you the latest in designer
              products straight out of fashion houses. You can shop online at
              Mystyle from the comfort of your home and get your favorites
          ...
          <div className={classes['footer-section']}>
            ...
            <p>
              Be it clothing, footwear or accessories, Mystyle offers you the
              ideal combination of fashion and functionality for men, women and
              kids. You will realize that the sky is the limit when it comes to
            ...
            <ol>
              <li>
                <p>
                  <strong>Smart men’s clothing -</strong> At Mystyle you will
                  ...
                  shirts are undebatably smart. Team them up with chinos, cuffed
                  jeans or cropped trousers for a smart casual look. Opt for a
                  stylish layered look with biker jackets. Head out in cloudy
                  weather with courage in water-resistant jackets. Browse
                  through our inner wear section to find supportive garments
              ...
              <li>
                <p>
                  ...
                  women at Mystyle is a mood-elevating experience. Look hip and
                  ...
                  favorites from among Bardot, off-shoulder, shirt-style,
              ...
              <li>
                <p>
                  <strong>Fashionable footwear - </strong> While clothes makes
              ...
              <li>
                <p>
                  ...
                  beauty and grooming products from Mystyle. Our soaps, shower
            ...
            <p>
              Mystyle is one of the best online shopping sites in India which
        ...
        {/* TODO: Show different more-info section based on route */}
        <div className={classes['more-info']}>
          <FooterMen />
        </div>
      </div>
